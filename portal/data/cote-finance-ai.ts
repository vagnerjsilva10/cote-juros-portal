export const aiBentoCards = [
  ...
  {
    icon: "verified_user",
    title: "Privacidade first-class",
    description: "Dados sob controle com governanca e consentimento granular.",
    dark: true
  }
];
...
export const aiPricingPlans = [
  {
    name: "Starter",
    price: "R$ 0",
    points: ["Painel essencial", "Alertas basicos", "Comparador inteligente"]
  },
  {
    name: "Premium",
    price: "R$ 29",
